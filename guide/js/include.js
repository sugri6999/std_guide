...
var gBaseURL = {
	...
	menu4: gRootURL.root +'guide/html/ia/',
...
var include = {
	meta : function(){
		document.write('<title>표준_퍼블리싱가이드 - Standard Guide</title>');
	...
	header : function(){
		...
		document.write('			<h1 class="g-logo"><a href="'+gBaseURL.guide+'">STD GUIDE</a></h1>');
	...
	aside : {
		...
		menu4 : function(){
			...
			document.write('					<li class="g-node1">');
			document.write('						<span>메뉴현황판</span>');
			document.write('						<ul class="g-depth2">');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_menu01.html">장기</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_menu02.html">자동차</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_menu03.html">마케팅</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_menu04.html">장기손사</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_comm.html">공통</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'ia_index.html">전체공통</a></li>');
			document.write('						</ul>');
			document.write('					</li>');
			document.write('				</ul>');
			document.write('				<!-- //Status Board -->');
